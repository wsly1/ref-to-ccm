...
public class apply_refprop_to_star extends StarMacro {{
  ...
  private void setLiquidProperties(Material material, Table table) {{
    ...
    setConstant(material, "star.energy.SaturationTemperatureProperty", {saturation_temperature_c:.12g}, "Saturation Temperature");
    setConstant(material, "star.energy.SpecificHeatProperty", {liquid.specific_heat_j_per_kg_k:.12g}, "Specific Heat");
    setConstant(material, "star.energy.StandardStateTemperatureProperty", {standard_state_temperature_c:.12g}, "Standard State Temperature");
    ...
    if (!setConstant(material, "star.userdefinedeos.UserDefinedDensityProperty", {liquid.density_kg_per_m3:.12g}, "Liquid User-defined EOS Density")) {{
    ...
    setConstant(material, "star.userdefinedeos.UserDefinedDrhoDTProperty", {liquid.density_temperature_derivative_kg_per_m3_k:.12g}, "Liquid Density Temperature Derivative");
